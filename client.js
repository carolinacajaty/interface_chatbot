...
const { GoogleGenerativeAI } = require('@google/generative-ai');  // Chargement du module externe via l'API Modules de CommonJS (require)

const targetModel = "gemini-2.5-flash";
const userMessage = "Hi, how are you?";

// Instanciation du client Gemini
const llmClient = new GoogleGenerativeAI({ apiKey: process.env.GEMINI_API_KEY });
